...
export default {
    generalInfoSection: [
        ...
        {
            "title": "Применение свёрточных нейросетей",
            "label": "Применение",
            "img_url": "/img/img_2.png",
            "text": (<>
                В 2010-е годы искусственные сверточные нейронные сети имели широкое использование в медицине и
                государственных учреждениях.<br/> В настоящее время сверточные нейронные сети применяются в системах
                видеонаблюдения, видеоаналитики и беспилотных автомобилях. Например, камеры в комплексе с такими сетями
                помогают роботам компании «Яндекс» и беспилотным такси понимать, что происходит на дороге. <br/>Другой
                популярной областью применения принципа работы сверточных нейронных сетей является генеративное
                искусство. Когда человек вводит запрос, нейронная сеть генерирует на его основе изображение.
                Преобразование текста является задачей различных алгоритмов, а генерация изображения – сверточных
                нейронных сетей. Наиболее распространенными моделями для генерации изображений являются такие сверточные
                нейронные сети, как Midjourney, Stable Diffusion, Dream, DALL-E 2 и ruDALL-E.
            </>),
            "url": ""
        },
        {
    ...
    useCasesSection: {
        title: (
            <>
                <span className="heading-gradient">Что вы можете сделать</span>
                <br/>
                <span className="heading-gradient">с сверточными нейросетями?</span>
            </>
        ),
        ...
        `,
                title: 'Классификация объектов на изображениях',
                description: 'CNN преуспевают в идентификации и категоризации объектов на изображениях, таких как различение кошек и собак или распознавание написанных от руки цифр.',
            },
            {
                ...
                title: 'Обнаружение и идентификация нескольких объектов',
                description: 'CNNS может точно обнаруживать и помечать различные объекты на изображении, позволяя таким приложениям, как автопилоты автомобилей, идентифицировать пешеходов, транспортные средства и дорожные знаки.',
            },
            {
        ...
        `,
                title: 'Аутентификация людей по изображениям',
                description: 'CNNs расширяет возможности систем распознавания лиц за счет анализа черт лица, обеспечивая безопасный контроль доступа, проверку личности и персонализированный пользовательский опыт.',
            },
            {
                icon: `
        ...
        `,
                ...
                description:
                    'CNNS помогают в медицинской диагностике, анализируя МРТ, компьютерную томографию и рентгеновские снимки, помогая выявлять аномалии, такие как опухоли или аномалии на медицинских изображениях.',
            },
            {
                ...
                description: 'CNNS может обрабатывать видеокадры для распознавания действий, отслеживания объектов и понимания контента для приложений наблюдения, обобщения видео и модерации контента.',
            },
            {
                ...
                description: 'CNN используются в генеративных моделях, таких как передача стиля и синтез изображений, позволяя создавать художественные работы, изменять стили изображений и генерировать реалистичные визуальные эффекты.',
            },
        ],
    },
    codeSection: {
